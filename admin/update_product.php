                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form action="update_product_action.php" method="POST" class="mx-1 mx-md-4" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example3c" class="form-control"
                                                    name="description" value = "<?php echo $product['description']?>" />
                                                <label class="form-label" for="form3Example3c">Mô tả sản phẩm</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example4c">Nhà sản xuất</label>
                                                <select id="areaSelect" name = "manufacturer">
                                                    <?php
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example4c">Loại súng</label>
                                                <select id="areaSelect" name="categories">
                                                    <?php
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <button type="submit" class="btn btn-primary btn-lg"
                                                name="create-product">Register</button>
                                        </div>
                                    </form>
